                ...
                <div className = "nft_add_form_disc">
                    ...
                    <div className = "add_things">
                        ...
                        <dl className="add_name">
                            ...
                            <dd><span>{contentnftdata.profileImg}</span><span>{contentnftdata.nickname}</span></dd>
                        </dl>
                        <dl className="add_name">
                        ...
                        <dl className="add_name">
                            ...
                            <dd><NftEditLeft type='text' id="title" placeholder="Enter NFT name" value={nfttitle} onChange={(e) => setnftTitle(e.target.value)}></NftEditLeft></dd>
                        </dl>
                        <dl className="add_image">
                            <dt className="d_left">NFT CONTENT</dt>
                            <dd>< textarea id="content" placeholder="Enter NFT content" value={nftcontent} onChange={(e) => setnftContent(e.target.value)} style={{width:'350px',padding: '20px', height:'70px', resize:'none',border: '1px solid grey'}}/></dd>
                        </dl>
                        ...
                        <dl className="add_content">
                            ...
                            <dd><NftEditLeft type="number" id="price" placeholder="Enter NFT price" value={nftprice} onChange={(e) => setnftPrice(e.target.value)}></NftEditLeft></dd>
                        </dl>
                    </div>

                    <div className="nft_add_button">
                    
                    <NftEditButton backgroundcolor="rgb(255,255,255)" color="#44C97C" border="1px solid #44C97C" type="button" height="54" radius="3" margin="0px" >취소</NftEditButton>
                    <NftEditButton onClick={onClickEditNft} backgroundcolor="#44C97C" color="rgb(255,255,255)" border="0px none" type="button" height="54" radius="3" margin="0px">등록</NftEditButton>
