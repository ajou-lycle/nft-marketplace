...
function ContentNft() {
  ...
  const onClickShowNft = () => {
    axios
      .get(`http://localhost:8080/nftItem/${nftInfoId}`, {
  ...
  const onClickLikeNft = () => {
    ...
    axios
      .post(
        `http://localhost:8080/nftItem/${nftInfoId}/like`,
        {},
        {
          withCredentials: true,
          headers: {
  ...
  const onClickDeleteNft = () => {
    ...
    console.log(userToken);
    axios
      .delete(`http://localhost:8080/nftItem/${nftInfoId}`, {
        withCredentials: true,
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("user_token")}`,
        },
  ...
  const onClickBuyNft = () => {
    axios
      .get(`http://localhost:8080/nftItem/${nftInfoId}/buy`, {
        withCredentials: true,
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("user_token")}`,
        },
  ...
  const onClickRealBuyNft = () => {
    ...
    axios
      .post(
        `http://localhost:8080/nftItem/${nftInfoId}/buy`,
        {},
        {
          withCredentials: true,
          headers: {
