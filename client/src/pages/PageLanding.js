        ...
        <section>
          <div className="row_content">
            <div className="left_content">
              ...
              <p
                {...useScrollFadeIn("up", 1.5, 0.8)}
                className="txt_box_sub_txt"
              >
                건강한 생활을 통해 얻은 NFT와 토큰이라는 보상을
                <br />
                실직적인 가치로 바꿔보세요.
              </p>
              <div
                {...useScrollFadeIn("up", 1.5, 0.8)}
                className="store_btn_wrapper"
              >
                <button
                  onClick={() =>
                    window.open(
                      "https://apps.apple.com/kr/app/nft-go-nft%EC%A0%9C%EC%9E%91-%ED%8C%90%EB%A7%A4%EA%B9%8C%EC%A7%80-%EC%9B%90%EC%8A%A4%ED%86%B1-%EB%A7%88%EC%BC%93%ED%94%8C%EB%A0%88%EC%9D%B4%EC%8A%A4/id1558876298",
                      "_blank"
                    )
                  }
                >
            ...
            <div
              {...useScrollFadeIn("up", 1.5, 0.4)}
              className="right_content preview_img_wrapper"
            >
