...
import { AccountCircle, AccountBalanceWallet, Favorite, Settings } from "@material-ui/icons";
  ...
  return(
    <div style={{
      ...
      <MypageMenu className="mypage_menu">
        ...
        <MypageMenuBar>
          <Link to='/myPage/:memberInfoId/like' style={{textDecoration:"none", color:"#333"}}>
            <IconButton>
              <Favorite />
            </IconButton>               
            <span>Favorites</span>
